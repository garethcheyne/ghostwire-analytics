...
import { DATA_TYPE, FIELD_LENGTH, ROLES, UNIT_TYPES } from './constants';
...
export const userRoleParam = z.enum([ROLES.admin, ROLES.user, ROLES.viewOnly]);

export const teamRoleParam = z.enum([ROLES.teamMember, ROLES.teamViewOnly, ROLES.teamManager]);
