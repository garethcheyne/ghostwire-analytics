...
export const AUTH_TOKEN = 'ghostwire.auth';
export const LOCALE_CONFIG = 'ghostwire.locale';
export const TIMEZONE_CONFIG = 'ghostwire.timezone';
export const DATE_RANGE_CONFIG = 'ghostwire.date-range';
export const THEME_CONFIG = 'ghostwire.theme';
export const CURRENCY_CONFIG = 'ghostwire.currency';
export const DASHBOARD_CONFIG = 'ghostwire.dashboard';
export const LAST_TEAM_CONFIG = 'ghostwire.last-team';
export const VERSION_CHECK = 'ghostwire.version-check';
export const SHARE_TOKEN_HEADER = 'x-ghostwire-share-token';
export const SHARE_CONTEXT_HEADER = 'x-ghostwire-share-context';
export const SHARE_TOKEN_TYPE = 'share';
export const CACHE_TOKEN_TYPE = 'cache';
export const PARTIAL_AUTH_TOKEN_TYPE = 'partial-auth';
// API keys are sent as `Authorization: Bearer gwa_...`.
export const API_KEY_PREFIX = 'gwa_';
export const HOMEPAGE_URL = 'https://github.com/garethcheyne/ghostwire-analytics';
export const REPO_URL = 'https://github.com/garethcheyne/ghostwire-analytics';
...
// Role names stored by Better Auth (see src/lib/auth-roles.ts). Keys keep Umami's names so
// ported permission code reads the same; user and team viewers share the 'viewer' value.
// Role names stored by Better Auth (see src/lib/auth-roles.ts). Keys keep Umami's names so
// ported permission code reads the same; user and team viewers share the 'viewer' value.
export const ROLES = {
  admin: 'admin',
...
export const ROLE_PERMISSIONS = {
  ...
  // ROLES.teamViewOnly is also 'viewer' and gets the same empty list as ROLES.viewOnly.
} as const;
