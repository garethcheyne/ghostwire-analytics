// Downloads the GeoLite2-City database into ./geo for visitor country/region/city lookups.
// Set GEO_DATABASE_URL or MAXMIND_LICENSE_KEY to use your own source; SKIP_BUILD_GEO to skip.
